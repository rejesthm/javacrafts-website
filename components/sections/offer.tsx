...
export function Offer() {
  return (
    <Section aria-labelledby="offer-heading" className="py-14">
      <div className="rounded-3xl border-2 border-brand-primary/30 bg-gradient-to-br from-brand-surface to-brand-bg p-8 shadow-md sm:p-10">
        <h2
          id="offer-heading"
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2">
          <div>
            <h3 className="text-lg font-bold text-brand-text">Included</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-brand-text">Bonuses</h3>
            <ul className="mt-4 space-y-3 text-brand-muted">
              {bonuses.map((line) => (
                <li key={line} className="flex gap-3">
            ...
            <div className="mt-8 rounded-2xl bg-brand-primary/10 p-5">
              <h3 className="font-bold text-brand-text">Pricing</h3>
              <p className="mt-2 text-brand-muted">
                Every piece is a little different. Send your idea—we’ll confirm the best
                option and total before we start.
              </p>
            </div>
            <div className="mt-6 rounded-2xl border border-brand-primary/25 p-5">
              <h3 className="font-bold text-brand-text">Our promise</h3>
              <p className="mt-2 text-brand-muted">
